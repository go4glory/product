jQuery(document).ready(function ($) {
    ...
    var baby_FILE_UPLOAD = {
        ...
        attach:function () {
            ...
            if (baby_file_uploader.upload_enabled !== '1') {
                return
            }

            var uploader = new plupload.Uploader(baby_file_uploader.plupload);
            ...
            uploader.bind('FileUploaded', function (up, file, response) {
                ...
                if (result.success) {
                   ...
                   $('#file_baby_nf_company_logo').val(img_src);
                }
            });
